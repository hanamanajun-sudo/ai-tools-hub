...
export const aiTools: AITool[] = [
  ...
  },
  {
    ...
    free: true,
    popular: true,
    features: ["터미널 기반 AI 에이전트", "도구 사용 자동화", "크론 작업 스케줄링", "멀티세션·메모리"],
    ...
    pros: ["완전 오픈소스 CLI 기반 — 터미널에서 직접 AI 에이전트 사용, 자유로운 커스터마이징", "도구 사용 및 크론 자동화 — 다양한 도구를 자동 선택·실행, 정기 작업 스케줄링", "멀티세션·메모리 — 세션 간 지속되는 메모리로 사용자 환경과 선호도 학습"],
