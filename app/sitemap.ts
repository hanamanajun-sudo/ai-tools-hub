...
// 여기엔 핵심 중에서도 내용 검증이 끝난 것만 넣는다. 핵심인데 아직 빠진 것(갱신하면 넣을 것):
// cursor(GPT-4o), deepseek(R1·2025년), perplexity(GPT-4), kling(2.0·2024년),
// capcut·manus·suno·veo·eleven-labs(가격 미검증).
